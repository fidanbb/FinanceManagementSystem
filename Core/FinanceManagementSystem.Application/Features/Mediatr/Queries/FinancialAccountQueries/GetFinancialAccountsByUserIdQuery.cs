...
{
    public class GetFinancialAccountsByUserIdQuery:IRequest<List<GetFinancialAccountsByUserIdQueryResult>>
    {
        public string UserId { get; set; }

        public GetFinancialAccountsByUserIdQuery(string userId)
        {
            UserId = userId;
        }
    }
